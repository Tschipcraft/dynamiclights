...
execute if score @s ts.dl.tnt.fuse matches ..1 at @s run summon area_effect_cloud ~ ~ ~ {Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:3,DurationOnUse:0f,Tags:["global.ignore","global.ignore.kill","global.ignore.pos","smithed.block","ts.dl.explosion"]}

# Detect other TNTs and Observers
execute if block ~1 ~ ~ #dynamiclights:tnt_exclude unless entity @e[type=minecraft:area_effect_cloud,tag=ts.dl.explosion,distance=..1] run summon area_effect_cloud ~ ~ ~ {Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:20,DurationOnUse:0f,Tags:["global.ignore","global.ignore.kill","global.ignore.pos","smithed.block","ts.dl.explosion"]}
execute if block ~-1 ~ ~ #dynamiclights:tnt_exclude unless entity @e[type=minecraft:area_effect_cloud,tag=ts.dl.explosion,distance=..1] run summon area_effect_cloud ~ ~ ~ {Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:20,DurationOnUse:0f,Tags:["global.ignore","global.ignore.kill","global.ignore.pos","smithed.block","ts.dl.explosion"]}
execute if block ~ ~ ~1 #dynamiclights:tnt_exclude unless entity @e[type=minecraft:area_effect_cloud,tag=ts.dl.explosion,distance=..1] run summon area_effect_cloud ~ ~ ~ {Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:20,DurationOnUse:0f,Tags:["global.ignore","global.ignore.kill","global.ignore.pos","smithed.block","ts.dl.explosion"]}
execute if block ~ ~ ~-1 #dynamiclights:tnt_exclude unless entity @e[type=minecraft:area_effect_cloud,tag=ts.dl.explosion,distance=..1] run summon area_effect_cloud ~ ~ ~ {Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:20,DurationOnUse:0f,Tags:["global.ignore","global.ignore.kill","global.ignore.pos","smithed.block","ts.dl.explosion"]}
execute if block ~ ~1 ~ #dynamiclights:tnt_exclude unless entity @e[type=minecraft:area_effect_cloud,tag=ts.dl.explosion,distance=..1] run summon area_effect_cloud ~ ~ ~ {Radius:0f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:20,DurationOnUse:0f,Tags:["global.ignore","global.ignore.kill","global.ignore.pos","smithed.block","ts.dl.explosion"]}
