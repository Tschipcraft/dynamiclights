...
execute if block ~ ~ ~ minecraft:light if score #light_exists ts.dl.settings matches 1 run function dynamiclights:internal/place_light/9/prev_it/update
...
execute unless block ~ ~ ~ minecraft:light run function dynamiclights:internal/place_light/9/place_block
