...
execute align xyz as @e[type=minecraft:marker,tag=ts.dl.new_light,distance=..0.1,limit=1] at @s run function dynamiclights:internal/place_light/12/summon_exec
