...
execute if score $curios_install ts.dl.version matches 1 as @s[type=minecraft:player] if data entity @s ForgeCaps.curios:inventory.Curios[0] run function dynamiclights:internal/sources/mod_support/curios/trigger_forge
execute if score $curios_install ts.dl.version matches 1 as @s[type=minecraft:player] if data entity @s neoforge:attachments.curios:inventory.Curios[0] run function dynamiclights:internal/sources/mod_support/curios/trigger_neoforge
